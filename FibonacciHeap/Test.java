...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        try {test19();} catch (Exception e){bugFound(e.getMessage() + "test19");}
        try {test20();} catch (Exception e){bugFound("test20");}
        try {test21();} catch (Exception e){bugFound("test21");}
        try {test22();} catch (Exception e){bugFound(e.getMessage() + "test22");}
    ...
    static void test16() {
        ...
        if (fibonacciHeap.potential() != 3) {
        	System.out.println(fibonacciHeap.potential());
        	System.out.println("prob 1 in 16");
            bugFound(test);
        }
        if (FibonacciHeap.totalCuts() - cuts != 0 ) {
        	System.out.println("prob 2 in 16");
            bugFound(test);
        }
        if (FibonacciHeap.totalLinks() - links != 0 ) {
        	System.out.println("prob 3 in 16");
            bugFound(test);
        }
        if (fibonacciHeap.countersRep()[0] != 3) {
        	System.out.println("prob 4 in 16");
            bugFound(test);
        }
    ...
    static void test20() {
        ...
        if (fibonacciHeap.potential() != 4) {
        	System.out.println(fibonacciHeap.potential());
        	System.out.println(fibonacciHeap.getNumOfTrees());
        	System.out.println(FibonacciHeap.getNonMarked());
        	System.out.println("part 1 test 20");
        	bugFound(test);
        }
        if (FibonacciHeap.totalCuts() - cuts != 1 ) {
        	System.out.println("part 2 test 20");
        	bugFound(test);
        }
        if (FibonacciHeap.totalLinks() - links != 0) {
        	System.out.println("part 3 test 20");
        	bugFound(test);
        }
    }
    ...
    static void test22() {
        ...
        //OurPrintHeap.printFibHeap(fibonacciHeap);
        if (fibonacciHeap.potential() != 1) {
        	System.out.println("part 1 test 22");
        	bugFound(test);
        }
        ...
        if (fibonacciHeap.potential() != treeSize) {
        	...
        	System.out.println(fibonacciHeap.getNumOfTrees());
        	System.out.println(fibonacciHeap.potential());
        	System.out.println("part 2 test 22");
        	bugFound(test);
        }
        if (FibonacciHeap.totalCuts() - totalCuts != treeSize - 1 ) {
        	System.out.println("part 3 test 22");
        	bugFound(test);
        }
        if (FibonacciHeap.totalLinks() - links != 0 ) {
        	System.out.println("part 4 test 22");
        	bugFound(test);
        }
        if (fibonacciHeap.countersRep()[0] != treeSize) {
        	System.out.println("part 5 test 22");
        	bugFound(test);
        }
        if (noCascading) {
        	System.out.println(FibonacciHeap.totalCuts());
        	System.out.println("part 6 test 22");
        	bugFound(test);
        }
    }
