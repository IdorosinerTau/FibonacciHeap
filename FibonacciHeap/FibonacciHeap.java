...
public class FibonacciHeap
{
    ...
    */
    ...
    private void consolidate() {
    	...
    	HeapNode[] heap_arr = new HeapNode[(int) (Math.log(getSize() + 1)/ Math.log(2)) + 1];
    ...
    */
    public int[] countersRep()
    {
    	...
    	int[] arr = new int[(int) Math.ceil(Math.log(getSize()+1)/Math.log(2)) + 1];
